...
const C = {
  ...
  addBg:    "var(--diff-add-bg, rgba(31, 136, 61, 0.28))",
  addLnBg:  "color-mix(in srgb, var(--diff-add-border, #1a7f37) 26%, var(--bg-secondary))",
  addText:  "var(--diff-add-text, #116329)",
  addWord:  "color-mix(in srgb, var(--diff-add-border, #1a7f37) 44%, transparent)",
  remBg:    "var(--diff-remove-bg, rgba(207, 34, 46, 0.24))",
  remLnBg:  "color-mix(in srgb, var(--diff-remove-border, #cf222e) 26%, var(--bg-secondary))",
  remText:  "var(--diff-remove-text, #a40e26)",
  remWord:  "color-mix(in srgb, var(--diff-remove-border, #cf222e) 44%, transparent)",
